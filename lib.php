...
/**
 * Plugin functions for the format_flexible2 plugin.
 *
...
class format_flexible2 extends core_courseformat\base {
 ...
 */
function format_flexible2_inplace_editable($itemtype, $itemid, $newvalue) {
    global $DB, $CFG;
